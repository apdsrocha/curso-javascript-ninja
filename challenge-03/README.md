...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Ana Rocha'
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura() // 'Minha altura é 1.59m.'
...
// 'Olá, eu sou a Ana Rocha, tenho 36 anos , 1.59 meu peso é 52 e, só hoje, eu já caminhei 30 metros'
